...
#include "NoradBase.hpp"

class SGP4 : public NoradBase
{
public:
	SGP4(const TLE& orbit) :
		NoradBase(orbit)
	{
	...
	virtual void GetPosition(double tsince)
	{
		...
		FinalPosition(m_Orbit.Inclination(), omgadf, e, a, xl, xnode, xn, tsince);
	}
